...
export const SfuModal = ({ isOpen, onClose }) => {
 ...
 <div className="mbox"><div className="m-hdr"><div className="m-hdr-icon">💬</div><h3>Sales Follow-Up</h3><button className="m-close" onClick={onClose} >✕</button></div>
 <div className="m-body">
  ...
  <div className="grid3"><div className="fg"><label>Make <span style={{"color":"var(--or1)","fontSize":"10px"}}>⚡ Auto</span></label><input id="sf_make" name="sf_make" value={formData['sf_make'] || ''} onChange={handleChange} placeholder="e.g. Maruti" /></div><div className="fg"><label>Model <span style={{"color":"var(--or1)","fontSize":"10px"}}>⚡ Auto</span></label><input id="sf_model" name="sf_model" value={formData['sf_model'] || ''} onChange={handleChange} placeholder="e.g. Swift VXI" /></div><div className="fg"><label>Reg No. <span style={{"color":"var(--or1)","fontSize":"10px"}}>⚡ Auto</span></label><input id="sf_regn" name="sf_regn" value={formData['sf_regn'] || ''} onChange={handleChange} placeholder="GJ-01-AB-1234" /></div></div>
  ...
  <div className="grid1"><div className="fg"><label>Remarks</label><textarea id="sf_rem" name="sf_rem" value={formData['sf_rem'] || ''} onChange={handleChange} placeholder="Notes…"></textarea></div></div>
 </div>
