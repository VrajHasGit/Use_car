...
export const DocModal = ({ isOpen, onClose, onSave, editData }) => {
 ...
 <div className="mbox" style={{"maxWidth":"900px"}}>
  ...
  <div className="m-body">
   ...
   <div className="grid3">
    <div className="fg"><label>Order Booking ID <span style={{"color":"var(--or1)","fontSize":"10px"}}>âš¡ Auto-Fill</span></label><input id="dc_obid" name="dc_obid" value={formData['dc_obid'] || ''} onChange={handleChange} placeholder="OB-2025-0001"  /></div>
    <div className="fg"><label>Vehicle Reg Number <span style={{"color":"var(--or1)","fontSize":"10px"}}>âš¡ Auto-Fill by RegNo</span></label><input id="dc_regn" name="dc_regn" value={formData['dc_regn'] || ''} onChange={handleChange} placeholder="GJ-01-AB-1234"  /></div>
   ...
   <div className="grid2">
    <div className="fg"><label>Customer Name <span style={{"color":"var(--or1)","fontSize":"10px"}}>âš¡ Auto</span></label><input id="dc_cname" name="dc_cname" value={formData['dc_cname'] || ''} onChange={handleChange} placeholder="Auto-fills from OB / Stock" readOnly style={{"background":"var(--surface2)","color":"var(--text2)"}} /></div>
    <div className="fg"><label>Car Details <span style={{"color":"var(--or1)","fontSize":"10px"}}>âš¡ Auto</span></label><input id="dc_carinfo" name="dc_carinfo" value={formData['dc_carinfo'] || ''} onChange={handleChange} placeholder="Make Â· Model Â· Year" readOnly style={{"background":"var(--surface2)","color":"var(--text2)"}} /></div>
   </div>

   
   <div className="sect-lbl"><i className="fa fa-clipboard-check"></i> Documents â€” Check &amp; Upload File</div>
   <div style={{"display":"grid","gridTemplateColumns":"1fr 1fr","gap":"10px","marginBottom":"14px"}}>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_rc_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_ins_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_puc_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_pan_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_adh_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_f29_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_f30_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_f28_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_f35_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_noc_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_gst_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_svc_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_inv_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_key_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bg)","border":"1px solid var(--border2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(59,130,246,.15)","border":"1px solid rgba(59,130,246,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_book_btn">ðŸ“Ž Upload</button>
   ...
   <div style={{"display":"grid","gridTemplateColumns":"1fr 1fr","gap":"10px","marginBottom":"14px"}}>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_badh_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_bpan_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_lbill_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_rent_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_tto_btn">ðŸ“Ž Upload</button>
    ...
    <div style={{"background":"var(--bl7)","border":"1px solid rgba(37,99,235,.2)","borderRadius":"var(--radius-sm)","padding":"10px 12px","display":"flex","alignItems":"center","gap":"10px"}}>
     ...
     <button  style={{"background":"rgba(37,99,235,.15)","border":"1px solid rgba(37,99,235,.3)","color":"var(--bl5)","borderRadius":"5px","padding":"4px 9px","fontSize":"10px","fontWeight":"600","cursor":"pointer","whiteSpace":"nowrap","flexShrink":"0"}} id="dc_bphoto_btn">ðŸ“Ž Upload</button>
