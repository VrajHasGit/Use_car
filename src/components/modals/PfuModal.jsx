...
export const PfuModal = ({ isOpen, onClose }) => {
 ...
 <div className="mbox"><div className="m-hdr"><div className="m-hdr-icon">📞</div><h3>Purchase Follow-Up</h3><button className="m-close" onClick={onClose} >✕</button></div>
 <div className="m-body">
  ...
  <div className="grid3"><div className="fg"><label>Negotiable Price ₹</label><input type="number" id="pf_nego" name="pf_nego" value={formData['pf_nego'] || ''} onChange={handleChange} placeholder="0"  /></div><div className="fg"><label>Customer Expectation ₹</label><input type="number" id="pf_exp" name="pf_exp" value={formData['pf_exp'] || ''} onChange={handleChange} placeholder="0"  /></div><div className="fg"><label>Offer Price ₹</label><input type="number" id="pf_offer" name="pf_offer" value={formData['pf_offer'] || ''} onChange={handleChange} placeholder="0"  /></div></div>
  <div className="grid2"><div className="fg"><label>Deal Close Price ₹</label><input type="number" id="pf_close" name="pf_close" value={formData['pf_close'] || ''} onChange={handleChange} placeholder="0" /></div><div className="fg"><label>Difference (Nego - Offer) ₹</label><div className="calc-out" id="pf_diff">₹ 0</div></div></div>
  <div className="grid2"><div className="fg"><label>Rejection Reason</label><input id="pf_rej" name="pf_rej" value={formData['pf_rej'] || ''} onChange={handleChange} placeholder="If rejected…" /></div><div className="fg"><label>Remarks</label><input id="pf_rem" name="pf_rem" value={formData['pf_rem'] || ''} onChange={handleChange} placeholder="Notes" /></div></div>
 </div>
