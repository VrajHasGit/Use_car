                ...
                <tr key={r.id}>
                  ...
                  <td>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6 }}>
                      ...
                      <button className="btn-icon bi-next" title="Send to Purchase Closer" onClick={() => pfuToCloser(r)} disabled={(lastFu.stat || lastFu.status || lastFu.pf_stat) !== 'Closed-Won'} style={{ opacity: (lastFu.stat || lastFu.status || lastFu.pf_stat) !== 'Closed-Won' ? 0.3 : 1, cursor: (lastFu.stat || lastFu.status || lastFu.pf_stat) !== 'Closed-Won' ? 'not-allowed' : 'pointer' }}><i className="fa fa-arrow-right"></i></button>
