...
const Finance = () => {
  ...
  return (
    <div className="page on" id="pg_finance">
      ...
      <div className="tc">
        <div className="tc-hdr"><div className="tc-title">Finance / Loan <span style={{background:'var(--bl5)',color:'#fff',fontSize:10,fontWeight:700,padding:'2px 8px',borderRadius:10,marginLeft:8}}>{records.length}</span></div></div>
